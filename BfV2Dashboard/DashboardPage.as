...
string BfDashJS_Settings()
{
    ...
    j += "c.appendChild(mkFieldRow('Target Group',mkNum('finetuner_target_group',1)));";
    j += "c.appendChild(mkFieldRow('Target Scalar',mkNum('finetuner_target_scalar',1)));";
    j += "c.appendChild(mkFieldRow('Target Towards',mkRange('finetuner_target_towards',-1,1,1)));";
    j += "c.appendChild(mkFieldRow('Target Value',mkNum('finetuner_target_value',0.1)));";
    ...
    j += "c.appendChild(mkFieldRow('Yaw Degrees',mkNum('shweetz_yaw_deg',1)));";
    j += "c.appendChild(mkFieldRow('Pitch Degrees',mkNum('shweetz_pitch_deg',1)));";
    j += "c.appendChild(mkFieldRow('Roll Degrees',mkNum('shweetz_roll_deg',1)));";
    ...
    j += "c.appendChild(mkFieldRow('Min Angle',mkNum('shweetz_angle_min_deg',1)));";
    j += "c.appendChild(mkFieldRow('Min Speed',mkNum('shweetz_condition_speed',1)));";
    j += "c.appendChild(mkFieldRow('Min CP',mkNum('shweetz_min_cp',1)));";
    j += "c.appendChild(mkFieldRow('Min Wheels on Ground',mkRange('shweetz_min_wheels_on_ground',0,4,1)));";
    j += "c.appendChild(mkFieldRow('Gear',mkNum('shweetz_gear',1)));";
    j += "c.appendChild(mkFieldRow('Trigger Index',mkNum('shweetz_trigger_index',1)));";
    j += "c.appendChild(mkFieldRow('Anti-Trigger Index',mkNum('shweetz_antitrigger_index',1)));";
    j += "return;}";
